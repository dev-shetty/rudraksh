# Contributing to Rudraksh

We appreciate your interest in contributing to Rudraksh! This document outlines the steps and guidelines for contributing to this project. By following these steps, you can ensure your contribution is smoothly integrated into the project.
...
1. Navigate to the [Rudraksh GitHub repository](https://github.com/Deveesh-Shetty/rudraksh).
...
```bash
  git clone https://github.com/YOUR_USERNAME/rudraksh.git
```
